...
# 📄 **README.md (Siap Tempel ke GitHub)**

Berikut README.md sesuai permintaan, gaya profesional dan rapi:
...
Repository ini berisi rangkuman materi **Modul Praktikum Basis Data (MySQL)** khusus untuk **Bab 1** dan **Bab 2**, lengkap dengan penjelasan konsep dasar dan contoh-contoh penting yang digunakan dalam pembuatan database relasional.

---

## 📘 Bab 1 — Konversi ER Diagram ke Skema Relasi

Bab ini membahas cara mengubah *Entity Relationship Diagram (ERD)* menjadi tabel fisik di database.

### 🔑 Materi Utama
- Pengertian entitas, atribut, primary key, relasi, dan kardinalitas.
- Aturan konversi ERD ke tabel:
  - Strong entity → 1 tabel
  - Composite attribute → dipecah menjadi kolom
  - Multivalue attribute → tabel baru
  - Weak entity → tabel dengan FK dari strong entity
  - One-to-One, One-to-Many, Many-to-Many conversion
  - Unary / recursive relationship
  - Ternary relationship
  - Generalisasi & Spesialisasi
- Contoh konversi pada studi kasus: **Skema Pembayaran Apotek** (hasil: 13 tabel)

---

## 📘 Bab 2 — Pengantar Basis Data & DDL

Bab ini memberikan dasar-dasar penggunaan MySQL dan perintah DDL.

### 🔑 Materi Utama
- Pengertian database & DBMS
- Pengenalan MySQL dan MariaDB (via XAMPP)
- Mengakses MySQL melalui CLI:
  ```bash
  mysql -u root -p
````

* Tipe data MySQL: INT, FLOAT, DATE, VARCHAR, BLOB, dll.
* Perintah DDL:
...
CLI (*Command Line Interface*) adalah antarmuka berbasis teks untuk menjalankan perintah langsung ke sistem.

Contoh CLI untuk MySQL:
...
* Membantu mahasiswa memahami dasar-dasar desain database.
* Menjadi referensi cepat dalam praktikum MySQL.
* Memudahkan proses pengembangan aplikasi berbasis database.

---

## 📄 Lisensi

Dokumen ini dibuat untuk kebutuhan pembelajaran dan praktikum.
...
✅ Tambahkan diagram ER ke PNG  
✅ Buatkan README versi English  
✅ Buat ringkasan Bab 3–Bab 12 juga  
✅ Bikin versi PDF untuk rangkuman ini  
